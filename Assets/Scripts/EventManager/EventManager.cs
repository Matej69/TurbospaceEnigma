...
public class EventManager : MonoBehaviour {
  ...
  public static UnityEvent                          event_planetClickedWithSpaceshipOnIt      = new UnityEvent();
  ...
  public static UnityEvent                          event_startSpaceshipLunchFromPlanet       = new UnityEvent();
  ...
  public static EventPlayerInSpaceshipRange         event_playerOnSurfaceAndInSpaceshipRange  = new EventPlayerInSpaceshipRange();
